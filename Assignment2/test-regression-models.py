...
def test_fit_predict():
    ...
    print("Values of your_variable for Normal Equation:", model.theta)
    print("Values of your_variable for Gradient Descent:", modelGD.theta)    
    
    # Define a tolerance for floating-point comparison
    tolerance = 0.1  # Adjust tolerance as needed

    # Perform a tolerance-based comparison
    comparison_ne = np.abs(model.theta - expected_array) < tolerance
    comparison_gd = np.abs(modelGD.theta - expected_array) < tolerance
